...
/**
 * CSVImporter is a component that handles importing password data from a CSV file.
...
const CSVImporter = ({
    ...
    const handleImport = async () => {
        ...
        Papa.parse(file, {
            ...
            error: () => {
                setError('Error parsing CSV file. Ensure the file is in a valid CSV format.');
                setIsUploading(false);
    ...
    return (
        <Dialog isOpen={isOpen} onClose={onClose} title="Import Passwords from CSV">
