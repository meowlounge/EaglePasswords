...
interface PasswordDialogProps {
    ...
    setNewPassword: (newPassword: Partial<Omit<Password, "id" | "createdAt" | "updatedAt">>) => void;
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div>
                    <label htmlFor="username" className="block text-sm text-neutral-400 mb-1">
                        Username
                    </label>
                    <Input
                        id="username"
                ...
                <div className="flex justify-end space-x-2 pt-4">
                    <Button
                        type="submit"
                        disabled={!newPassword.password?.trim()}
                    >
