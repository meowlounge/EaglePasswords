...
/**
 * ImporterDialog is a component that handles importing password data from either CSV or JSON format.
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} title="Import Passwords">
      <div className="space-y-4">
        <div>
          <label className="block text-sm">Choose Import Format</label>
          <select
            value={importFormat}
