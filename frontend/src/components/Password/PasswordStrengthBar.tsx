...
export const gradientVariants = {
  danger:
    "bg-gradient-to-tr from-red-500 to-red-700 dark:from-red-600 dark:to-rose-950",
  warning:
    "bg-gradient-to-tr from-yellow-400 to-orange-600 dark:from-amber-600 dark:to-orange-950",
  success:
    "bg-gradient-to-tr from-green-400 to-green-600 dark:from-green-600 dark:to-emerald-950",
