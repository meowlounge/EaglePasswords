...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      {isMobileOpen && (
        <div
          className="fixed inset-0 bg-neutral-100/60 dark:bg-neutral-950/60 backdrop-blur-xs md:hidden z-40 transition-opacity"
        ...
        <div className="flex items-center h-16 px-6 border-b border-neutral-300 dark:border-neutral-700">
          <span className="text-lg font-semibold text-neutral-700 dark:text-neutral-200">
            ...
            <Link
              ...
              className="text-neutral-500 hover:text-fuchsia-500 dark:hover:text-purple-600 transition-colors duration-300 dark:text-neutral-400"
            >
              Passwords
            </Link>
          </span>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-[280px] md:hidden bg-neutral-100/75 dark:bg-neutral-900 backdrop-blur-xl transform transition-transform duration-300 ease-in-out ${isMobileOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        <div className="flex items-center justify-between h-16 px-6 border-b border-neutral-300 dark:border-neutral-700">
          <span className="text-lg font-semibold text-neutral-700 dark:text-neutral-200">
            ...
            <Link
              href={"https://prodbyeagle.vercel.app/"}
              className="text-neutral-500 hover:text-purple-300 transition-colors duration-300 dark:text-neutral-400 dark:hover:text-purple-300"
            >
              Passwords
            </Link>
          </span>
